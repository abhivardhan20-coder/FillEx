...
function Brand() {
  return (
    ...
    >
      <span className="flex size-9 items-center justify-center rounded-xl bg-violet-600 text-white shadow-lg shadow-violet-600/20">
        <span className="text-sm font-black tracking-tight">FX</span>
      </span>
      <span>
        <span className="block text-base font-bold tracking-tight">FillEx</span>
      ...
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-64 border-r bg-card/90 backdrop-blur-xl lg:flex lg:flex-col">
        ...
        <div className="m-3 rounded-xl border bg-muted/45 p-3">
          <div className="flex items-center gap-2 text-xs font-medium">
            <span className="size-2 rounded-full bg-amber-500" /> Data sources
            not configured
          </div>
      ...
      <div className="lg:pl-64">
        <header className="sticky top-0 z-20 border-b bg-background/88 backdrop-blur-xl">
          <div className="mx-auto flex h-16 max-w-7xl items-center gap-3 px-4 md:px-6 lg:px-8">
            <button
              type="button"
              className="rounded-lg border bg-card p-2 lg:hidden"
            ...
            <Link
              href="/markets"
              className="ml-auto hidden min-w-64 items-center gap-2 rounded-xl border bg-card px-3 py-2 text-sm text-muted-foreground transition-colors hover:border-violet-300 hover:text-foreground sm:flex"
            >
              <Search className="size-4" /> Search NSE or BSE
            ...
            <Link
              href="/integrations"
              className="ml-auto rounded-lg border bg-card px-3 py-2 text-xs font-semibold text-foreground hover:bg-muted sm:ml-0"
            >
              Connect sources
            </Link>
          </div>
