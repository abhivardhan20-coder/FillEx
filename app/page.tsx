        ...
        <div className="grid gap-4 lg:grid-cols-3">
          {sourceCards.map(({ title, description, href, action, icon: Icon }) => (
            <Card key={title} className="transition-transform hover:-translate-y-0.5">
              <CardHeader>
                <div className="mb-3 flex size-10 items-center justify-center rounded-xl bg-violet-500/10 text-violet-700"><Icon className="size-5" /></div>
                <CardTitle>{title}</CardTitle><CardDescription className="min-h-12 leading-5">{description}</CardDescription>
              </CardHeader>
