...
export default function IntegrationsPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeading eyebrow="Integrations" title="Real sources, explicit status" description="Credentials are read only from server-side environment variables. FillEx never asks you to paste API secrets into the browser." action={<span className="inline-flex items-center gap-2 rounded-full border bg-card px-3 py-1.5 text-xs font-medium"><CircleDashed className="size-3.5 text-amber-600" />{connected} of {production.length} credentialed providers connected</span>} />
